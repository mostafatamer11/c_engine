...
void drmProcessMouseInput(Camera* camera, float xOffset, float yOffset) {
	...
	drmUpdateCameraVectors(camera);
}

void drmMouseCallback(GLFWwindow* window, double xpos, double ypos) {
	...
	drmProcessMouseInput(camera, xOffset, yOffset);
}
...
void drmProcessKeyboardInput(Camera* camera, GLFWwindow* window, float deltaTime) {
